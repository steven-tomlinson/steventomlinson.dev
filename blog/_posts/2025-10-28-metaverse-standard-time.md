...
Metaverse Standard Time (MST) is set to UTC+12, providing a single, fixed reference for all metaverse participants. To convert your local time to MST, simply add 12 hours to Coordinated Universal Time (UTC). For example, if it is 8:00 PM UTC, MST will be 8:00 AM the next day.
