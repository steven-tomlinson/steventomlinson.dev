**Full-stack Software and Database Engineer**  
Las Vegas, NV | steven.tomlinson@gmail.com |   
...
**Founder & Architect \- Lockb0x Protocol \+ Pakana | 2022-Present**  
*(Revised bullets added to signal hands-on development and delivery)*

* Designed and implemented **ASP.NET Core and MVC applications** supporting CRUD workflows, role-based access control, and high-volume transactional data.  
* Built **data access layers using Entity Framework Core and Dapper**, optimizing queries and stored procedures in SQL Server.  
* Developed and maintained **RESTful Web APIs** consumed by web and internal systems.  
* Implemented **background processing and scheduled jobs** using Windows Services and Task Scheduler equivalents.  
* Performed hands-on debugging, performance tuning, and production issue resolution.  
* Architected and deployed Lockb0x Codex: a decentralized IPFS-based content registry linked to blockchain transaction anchors.  
* Developed Stellar Razor & Blazor Components to integrate Web3 functionality into .NET web applications.  
* Led design of agentic AI tools for compliance tracking, deliverable validation, and user-guided workflows.

**Technical Advisor / Consultant (Freelance) | 2020-Present**

* Delivered technical solutions for small businesses, civic tech startups, and fintech orgs seeking custom backend and integration systems.

Experience

* **7/2022 – Present** – Building Pakana.net, a Title and IP Asset Lien/Release/Title Management SaaS Application utilizing decentralized ledgers and storage. Designed SQL schema, Entity Framework ORM layer (Dapper), DotNet codebase, and Razor UI/UX. Assisted by CoPilot, ChatGPT Codex, and Gemini,  
* **6/2023 \- 11/2025** \- Architected enterprise application strategy for family office's holding company. Designed architecture and technology specification for M365, internal HR, Payroll, etc.  
* **3/2023 \- 9/2023** \- Designed, proposed, and awarded a grant to build the Stellar Identity Framework, enabling blockchain identity, ledger operations, and federated identity resolution via Razor Pages. Designed SQL Server schemas, views, indexes, and stored procedures supporting enterprise reporting and high-volume transactional systems.  
* **8/2022 \- 2/2023** \- Designed, proposed, and awarded a grant to develop the Stellar Razor Component Library, a set of UI/UX components to abstract blockchain operations.  
...
* **6/1999 \- 12/2002** \- Designed, developed, and built a city-wide WiFi network in Honolulu using early (2MBps) WiFi technology. Developed a custom ASP.NET website with [VB.NET](http://VB.NET) and MS-SQL Server to accept payments using [Authorize.net](http://Authorize.net), then using Active Directory with DHCP allocate routable IP addresses to allow public Internet access via WiFi in downtown Honolulu and Wiaikiki. Sold to Oceanic Time-Warner.  
* **1/1998 \- 12/1998** \- Designed and implemented a high-speed airline ticket scanning, OCR, and data validation system for Hawaiian Airlines.Built with VB5  
* **1992** \- Developed a Correspondence and Contact Management Application for The Governor's Office of Hawaii using Visual Basic 3 and an MS-Access (MDB) database file.  
* **1990-1995** \- RadioShack Tandy Computer Center Assistant Manager, Honolulu, HI

Education & Credentials

* Microsoft Certified Professional (MCP)  
* Azure AI Foundry Certification  
* Google Al for Leaders Certification  
* DeFi Specialization – Duke University (Coursera)  
* Nevada Escrow Agent Pre-Licensing Education: Escrow Agent Essentials  
* Ongoing continuous learning in generative AI, blockchain, data governance, and secure protocol development.